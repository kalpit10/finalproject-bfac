[finalproject-bfac] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [finalproject-bfac] container is NOT running**.

.. tip::
   You must have your [finalproject-bfac] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/kalpit10/rasberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=38443  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='kalpit10'  \-\-env DOCKERUSERNAME='kalpit10'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   kalpit10/finalproject-bfac-amd64 (https://hub.docker.com/r/kalpit10/finalproject-bfac-amd64)
...
.. code-block::
   ...
   docker run -d -p 33015:33015 -p 40839:40839 -p 42941:42941 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=finalproject-bfac \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-finalproject-bfac \-\-env GITUSERNAME=kalpit10  \-\-env GITREPOURL=https://github.com/kalpit10/rasberrypi \-\-env SOLUTIONEXTERNALPORT=33015  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=40839  \-\-env SOLUTIONVIPERVIZPORT=42941 \-\-env DOCKERUSERNAME='kalpit10' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=38443 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  kalpit10/finalproject-bfac-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - kalpit10/finalproject-bfac-amd64
...
[finalproject-bfac] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/kalpit10/rasberrypi/tree/main/tml-airflow/dags/tml-solutions/finalproject-bfac
...
.. important::
   https://finalproject-bfac.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-finalproject-bfac
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=33015, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=43433, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=35063, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=34681, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=45759, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=35855, HPDEHOST=127.0.1.1, HPDEPORT=43749, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=39581

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-1294-finalproject-bfac,solution_preprocessing_ai_mqtt_dag-finalproject-bfac, python-preprocess-8534-finalproject-bfac,solution_preprocessing_ai_mqtt_dag-finalproject-bfac, python-ai-6557-finalproject-bfac,solution_preprocessing_ai_mqtt_dag-finalproject-bfac, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
