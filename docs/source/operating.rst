...
Generated On: 2024-11-14 21:29:12 UTC
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/kalpit10/rasberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=45711  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='kalpit10'  \-\-env DOCKERUSERNAME='kalpit10'  \-\-env MQTTUSERNAME='kalpit.swami@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   docker run -d -p 50967:50967 -p 48537:48537 -p 43763:43763 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=finalproject-bfac \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-finalproject-bfac \-\-env GITUSERNAME=kalpit10  \-\-env GITREPOURL=https://github.com/kalpit10/rasberrypi \-\-env SOLUTIONEXTERNALPORT=50967  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=48537  \-\-env SOLUTIONVIPERVIZPORT=43763 \-\-env DOCKERUSERNAME='kalpit10' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=45711 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='kalpit.swami@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  kalpit10/finalproject-bfac-amd64
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=50967, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=35697, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=33457, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=33249, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=35605, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=36061, HPDEHOST=127.0.1.1, HPDEPORT=45227, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=41365

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-7533-finalproject-bfac,solution_preprocessing_ai_mqtt_dag-finalproject-bfac, python-preprocess-4420-finalproject-bfac,solution_preprocessing_ai_mqtt_dag-finalproject-bfac, python-ai-6521-finalproject-bfac,solution_preprocessing_ai_mqtt_dag-finalproject-bfac, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
